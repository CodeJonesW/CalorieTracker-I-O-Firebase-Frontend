        ...
        {localStorage["jwt_token"] && !this.props.user.userInfo.id ? null : (
          <Switch>
            <Route
              ...
              path="/profile"
              render={() =>
                localStorage.jwt_token ? <Profile /> : <Redirect to="/" />
              }
            />
            <Route
              exact
            ...
            <Route
              exact
              path="/editconsumption"
              render={() => <EditConsumptionForm />}
            />
